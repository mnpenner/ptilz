...
class BigMathTest extends PHPUnit_Framework_TestCase {
    ...
    function testLn() {
        ...
        $this->assertEquals(422.84247877853525521000874739064622412539399649281,BigMath::ln('43466557686937456435688527675040625802564660517371780402481729089536555417949051890403879840079255169295922593080322634775209689623239873322471161642996440906533187938298969649928516003704476137795166849228875'),'',self::EPSILON);
        $this->assertEquals(183.63815524781072436687895868491766333584333485894,BigMath::log('43466557686937456435688527675040625802564660517371780402481729089536555417949051890403879840079255169295922593080322634775209689623239873322471161642996440906533187938298969649928516003704476137795166849228875',10),'',self::EPSILON);
